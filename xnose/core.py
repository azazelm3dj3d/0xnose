"""Implements xnose test program and collector.
"""
...
from xnose.loader import defaultTestLoader
from xnose.plugins.manager import PluginManager, DefaultPluginManager, \
     RestrictedPluginManager
from xnose.result import TextTestResult
from xnose.suite import FinalizingSuiteWrapper
from xnose.util import isclass, tolist


log = logging.getLogger('xnose.core')
...
class TextTestRunner(unittest.TextTestRunner):
    """Test runner that uses xnose's TextTestResult to enable errorClasses,
...
class TestProgram(unittest.TestProgram):
    ...
    * env: Environment; ignored if config is provided (default: None;
      os.environ is read)
    * config: :class:`xnose.config.Config` instance (default: None)
    * suite: Suite or list of tests to run (default: None). Passing a
      ...
      be called. If you want normal xnose behavior, either pass a list
      of tests, or a fully-configured :class:`xnose.suite.ContextSuite`.
