"""xnose unittest.TestCase subclasses. It is not necessary to subclass these
classes when writing tests; they are used internally by xnose.loader.TestLoader
...
from xnose.failure import Failure # for backwards compatibility
from xnose.util import resolve_name, test_address, try_run
...
class Test(unittest.TestCase):
    ...
    test property of the xnose.case.Test instance.
    """
    __test__ = False # do not collect
    def __init__(self, test, config=None, resultProxy=None):
        # sanity check
        if not callable(test):
            raise TypeError("xnose.case.Test called with argument %r that "
...
class FunctionTestCase(TestBase):
    ...
    Don't use this class directly; it is used internally in xnose to
