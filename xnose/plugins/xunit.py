...
Add this shell command to your builder ::
    ...
    xnosetests --with-xunit

And by default a file named xnosetests.xml will be written to the
working directory.
...
Here is an abbreviated version of what an XML test report might look like::
    ...
    <testsuite name="xnosetests" tests="1" errors="1" failures="0" skip="0">
...
from xnose.pyversion import force_unicode, format_exception
...
class Xunit(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option(
            ...
            default=env.get('NOSE_XUNIT_FILE', 'xnosetests.xml'),
            help=("Path to xml file to store the xunit report in. "
                  "Default is xnosetests.xml in the working directory "
                  "[NOSE_XUNIT_FILE]"))

        parser.add_option(
            '--xunit-testsuite-name', action='store',
            dest='xunit_testsuite_name', metavar="PACKAGE",
            default=env.get('NOSE_XUNIT_TESTSUITE_NAME', 'xnosetests'),
