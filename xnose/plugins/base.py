...
from xnose.util import tolist

class Plugin(object):
    """Base class for xnose plugins. It's recommended but not *necessary* to
    ...
    * The plugin will not be enabled unless this option is selected by
    ...
    def addOptions(self, parser, env=None):
        ...
        .. warning :: Don't implement addOptions unless you want to override
                      ...
                      :meth:`options
                      <xnose.plugins.base.IPluginInterface.options>`
                      instead.
        """
    ...
    def add_options(self, parser, env=None):
        ...
        .. warning ::
           ...
           use :meth:`options <xnose.plugins.base.IPluginInterface.options>`
           instead.
    ...
    # Compatiblity shim
    def tolist(self, val):
        warn("Plugin.tolist is deprecated. Use xnose.util.tolist instead",
             DeprecationWarning)
        return tolist(val)
...
class IPluginInterface(object):
    ...
    def addOptions(self, parser, env):
        ...
        .. warning ::
           ...
           :meth:`options <xnose.plugins.base.IPluginInterface.options>` instead.
        """
        pass
    ...
    def addError(self, test, err):
        ...
        :type test: :class:`xnose.case.Test`            
    ...
    def finalize(self, result):
        ...
        .. Note:: When tests are run under a test runner other than
           :class:`xnose.core.TextTestRunner`, such as
    ...
    def describeTest(self, test):
        ...
        Called by :meth:`xnose.case.Test.shortDescription`.
    ...
    def loadTestsFromModule(self, module, path=None):
        ...
        :param path: the path of the module to search, to distinguish from
            ...
            .. note::
               ...
               NEW. The ``path`` parameter will only be passed by xnose 0.11
               or above.
        """
        pass
    ...
    def prepareTestCase(self, test):
        ...
        xnose.case.Test instance; the case to be executed is in the
        ...
        side-effect the xnose.case.Test instance you have been passed.
    ...
    def prepareTestLoader(self, loader):
        ...
        loader. Only valid when using xnose.TestProgram.

        :param loader: :class:`xnose.loader.TestLoader` 
    ...
    def prepareTestResult(self, result):
        ...
        proxy system. The TestRunner and TestProgram -- whether xnose's
        ...
        :param result: :class:`xnose.result.TextTestResult` 
    ...
    def prepareTestRunner(self, runner):
        ...
        test runner, return None. Only valid when using xnose.TestProgram.

        :param runner: :class:`xnose.core.TextTestRunner` 
    ...
    def testName(self, test):
        """Return a short test name. Called by `xnose.case.Test.__str__`.
