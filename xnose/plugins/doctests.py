...
(instead of being grouped into packages or modules of their own), xnose only
...
from xnose.suite import ContextList
from xnose.util import anyp, getpackage, test_address, resolve_name, \
...
try:
    ...
    import xnose.ext.dtcompat as doctest
...
class Doctest(Plugin):
    ...
    def loadTestsFromModule(self, module):
        ...
        try:
            ...
            # xnose allows module.__test__ = False; doctest does not and throws
            # AttributeError
            return
        if not tests:
