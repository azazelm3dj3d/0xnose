...
course of test execution within xnose -- you won't be doing this
yourself. For the purposes of this testing document, I'm stepping
through the internal process of xnose so you can see what happens at
each step.
...
from xnose.pyversion import make_instancemethod
from xnose.plugins.base import Plugin
from xnose.result import TextTestResult
from xnose.util import isclass
