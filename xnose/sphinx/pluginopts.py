...
this::
 ...
 .. autoplugin :: xnose.plugins.foo
    :plugin: Pluggy
    
produces::

  .. automodule :: xnose.plugins.foo
  ...
  .. autoclass :: xnose.plugins.foo.Pluggy
     :members:

  Source
  ------

  .. include :: path/to/xnose/plugins/foo.py
     :literal:
...
from xnose.util import resolve_name
...
class OptBucket(object):
    def __init__(self, doc=None, prog='xnosetests'):
        self.opts = []
        self.doc = doc
        self.prog = prog
