...
from xnose.util import isclass, ln as _ln # backwards compat

log = logging.getLogger('xnose.result')
...
def ln(*arg, **kw):
    ...
    warn("ln() has moved to xnose.util from xnose.result and will be removed "
         "from xnose.result in a future release. Please update your imports ",
         DeprecationWarning)
    return _ln(*arg, **kw)
