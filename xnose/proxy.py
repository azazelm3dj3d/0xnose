...
however, plugins are called with the xnose.case.Test instance that
...
the xnose.case.Test that they receive.
"""
import logging
...
class ResultProxy(object):
    ...
    One ResultProxy is created for each xnose.case.Test. The result
    proxy calls plugins with the xnose.case.Test instance (instead of
    the wrapped test case) as each result call is made. Finally, the
    real result method is called, also with the xnose.case.Test
