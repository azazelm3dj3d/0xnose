...
"""Test the copy of xnose in this directory, by running that xnose against itself.

You can test xnose using xnose in other ways, but if you don't use this script,
you might have one installation of xnose testing another installation, which is
not supported.
"""

# More detail:

# In the absence of some sort of deep renaming magic, xnose can't reasonably
...
# easy-install.pth) takes you at your word and ensures that the installed xnose
# comes first on sys.path .  So the only way to test a copy of xnose other than
# the installed one is to install that version (e.g. by running python setup.py
# develop).

# This script provides a way of running xnose on xnose's own tests without
...
if __name__ == "__main__":
    ...
    if sys.version_info >= (3,):
        ...
        # build/tests (including xnose itself, since some tests are inside the
        # xnose source)
