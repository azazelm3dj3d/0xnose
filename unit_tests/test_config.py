...
class TestNoseConfig(unittest.TestCase):
    ...
    def test_testnames(self):
        ...
        c = xnose.config.Config(testNames=['foo'])
        c.configure([])
    ...
    def test_progname_looks_like_option(self):
        ...
        # this matters eg. with python -c "import xnose; xnose.main()"
    ...
    def test_pickle_configured(self):
        ...
        c = xnose.config.Config(plugins=DefaultPluginManager())
